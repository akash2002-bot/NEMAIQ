...
"""
NemaIQ - Data Module
Contains all research data for EPN species.
"""
...
SPECIES_DATA = {
    "Heterorhabditis indica": {
        ...
        "description": "Heterorhabditis indica is a highly effective entomopathogenic nematode for controlling a wide range of soil-dwelling pests. It is known for its excellent host-finding ability and tolerance to various soil conditions.",
        "icon": "🐛",
        "color": "#2E7D32",
    },
    "Steinernema siamkayai": {
        ...
        "saline_tolerance": {"max": 15.0, "min": 20.0, "unit": "dS/m"},
        ...
        "description": "Steinernema siamkayai is a versatile entomopathogenic nematode species effective against a broad spectrum of pests. It performs well across a wide pH range and is particularly effective in sandy soils.",
        "icon": "🪱",
        "color": "#1565C0",
    },
}
